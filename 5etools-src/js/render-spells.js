...
class _RenderSpellsImplClassic extends _RenderSpellsImplBase {
	...
	_getRendered ({ent, opts, renderer}) {
		...
		htmlPtFrom = htmlPtFrom ? `<div class="vtt-spell-source-footer">${htmlPtFrom}</div>` : "";
		htmlPtPage = htmlPtPage ? htmlPtPage.replace(/(<td[^>]*>)([\s\S]*?)(<\/td>)/i, '$1<div class="vtt-spell-source-footer">$2</div>$3') : "";
